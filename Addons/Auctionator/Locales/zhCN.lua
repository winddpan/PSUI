...
AtrL["Auctionator memory usage:"] = "Auctionator 存储器用量"
...
AtrL["Automatically cancel all of your auctions|n|nthat are not the lowest priced?"] = "自动下架目前被压价物品?"
...
AtrL["Check for Undercuts"] = "压价检查"
AtrL["Checking stopped"] = "检查停止"
AtrL["Cleaning up"] = "清理"
AtrL["Common items"] = "普通物品"
AtrL["Common"] = "普通"
AtrL["Configure how you typically like to sell the items listed below."]="设定卖出时的堆叠偏好"
AtrL["Continue"] = "继续"
...
AtrL["Date"] = "日期"
AtrL["days"]="天"
AtrL["Default Auctionator tab"] = "开启拍卖时打开页面"
AtrL["default behavior"] = "预设"
AtrL["Delete Shopping List"] = "删除购物清单"
AtrL["Deposit"] = "保证金"
AtrL["Disenchant"] = "分解"
AtrL["Done"] = "完成"
...
AtrL["Duration"] = "时限"
AtrL["Edit"] = "编辑"
AtrL["Enable alt-key shortcut"]="启用Alt键快速上架"
...
AtrL["If this option is checked, every time you initiate a new auction the auction duration will be reset to the default duration you've selected."]="若勾选此选项，每当你摆放拍卖物品时，将自动设定有效期"
...
AtrL["Minimum quality level:"] = "最低物品质量"
AtrL["More"] = "压价管理"
AtrL["Name for your new shopping list"] = "购物清单名称"
AtrL["never"] = "从不"
AtrL["Never"] = "从不"
AtrL["New Shopping List"] = "新增购物清单"
AtrL["New"] = "新建"
...
AtrL["Rare"] = "精良"
AtrL["Really delete the shopping list %s ?"] = "确定要删除购物清单 %s ?"
AtrL["Entry must not be blank"] = "不能为空"
...
AtrL["Chinese/Taiwan translation courtesy of %s"] = "中文翻译: %s"
...
AtrL["Yesterday"] = "昨天"
AtrL["You can buy at most %d auctions"] = "你最多可购买 %d 项拍卖物品"
...
AtrL["You may have no more than\n\n%d items on a shopping list."] = "购物清单最多可设定 %d 物品"
AtrL["your auction on"] = "你拍卖于"
AtrL["your most recent posting"] = "你最近的拍卖"
AtrL["yours"] = "你的"
AtrL["Advanced"] = "高级搜索"
AtrL["Exact Match"] = "精确匹配"
AtrL["Options..."] = "设置"
AtrL["Manage Shopping Lists"] = "管理购物清单"
AtrL["Default Auction Duration"] = "默认拍卖时间"
AtrL["Clear Shopping Lists"] = "删除所有购物清单"
AtrL["Clears"] = "数据管理"
AtrL["Clear Scanning History"] = "清空价格数据库"
AtrL["Clear Stacking Preferences"] = "清空堆叠设置"
AtrL["Clear Posting History"] = "删除拍卖记录"
AtrL["Delete"] = "删除"
AtrL["Rename"] = "重命名"
AtrL["Export"] = "导出"
AtrL["Clear It"] = "确定"
AtrL["Import"] = "导入"
AtrL["Select multiple shopping lists by holding down the control key while clicking"] = "按住Ctrl键选中多个清单"
AtrL["When the Auction House is open\nclicking this button tells Auctionator\nto scan for the item and all its reagents."] = "打开拍卖行界面后再点击AH按钮\nAuctionator将会自动搜索该物品\n和制作该物品所需的材料!"
AtrL["Save this Shopping List"] = "保存这个购物清单"
