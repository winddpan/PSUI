...
editFilterFrame.header:SetText('编辑筛选')
...
filterNameFrame.ruleDescription:SetText('筛选命名:')
...
editFilterFrame:SetScript('OnShow', function(self)
    if not filterChoiceMenu then
        filterChoiceMenu = {}
        filterChoiceMenu[1] = {text="分类", notCheckable = true, isTitle = true}
...
editFilterFrame.addRule:SetText('添加规则')
...
editFilterFrame.dismissButton:SetText('完成')
