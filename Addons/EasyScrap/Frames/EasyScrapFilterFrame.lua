...
filterFrame.header:SetText('管理筛选')
...
infoFrame.subText:SetText("单击筛选的名称将其设置为默认筛选.")
...
function filterFrame:drawFilters()
    ...
    filterFrame.header:SetText('管理筛选 ('..#EasyScrap.saveData.customFilters..')')
end
...
filterFrame.createNewButton:SetText('创建筛选')
...
filterFrame.dismissButton:SetText('确定')
