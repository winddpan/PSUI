...
button = makeButton("OpenAllButton", "打开全部", 90, 25, -50, 12)
button:SetScript("OnClick", openAll)
button:SetScript("OnEvent", onEvent)
button2 = makeButton("OpenAllButton2", "获取金币", 90, 25, 50, 12)
button2:SetScript("OnClick", openAllCash)

button:SetScript("OnEnter", function()
	GameTooltip:SetOwner(button, "ANCHOR_RIGHT")
	GameTooltip:AddLine(string.format("%d 封邮件", GetInboxNumItems()), 1, 1, 1)
	GameTooltip:Show()
end)
