...
cfg.backdrop.bgColor = {0,0,0,.65}
cfg.backdrop.borderColor = {0,0,0,.95}
...
local function OnTooltipSetUnit(self)
  ...
  if not UnitIsPlayer(unit) then
    ...
    if unitClassification == "worldboss" or unitClassification == "rare" or unitClassification == "rareelite" or UnitLevel(unit) == -1 then
