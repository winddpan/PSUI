...
local minor = 1050 --Idioits keep fucking up the correct DRs
...
local spellsAndProvidersByCategory = {
	...
	incapacitate = {
		...
		[236025] = true, -- Maim incap with Enraged main (not confirmed)
		[236026] = true, -- Maim incap spellID from Talent not sure if real
		--Demon hunter
		[217832] = true, -- Imprisonment
		[221527] = true, -- Improved Imprisonment
		-- Hunter
