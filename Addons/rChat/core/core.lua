  ...
  local function skinChat(self)
    ...
    self:SetFont(STANDARD_TEXT_FONT, 12, "NONE")
    self:SetShadowOffset(1,-1)
    self:SetShadowColor(0,0,0,0.88)
    ...
    eb:ClearAllPoints()
    eb:SetPoint("BOTTOM",self,"TOP",0,30)
    ...
    tabFs:SetFont(STANDARD_TEXT_FONT, 13, "NONE")
    tabFs:SetShadowOffset(1,-1)
    tabFs:SetShadowColor(0,0,0,0.88)
